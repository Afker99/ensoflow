document.addEventListener("DOMContentLoaded", (event) => {
  ...
  // 1. Heading
  eventsTimeline.from("#events-header h1", {
    y: 50,
    opacity: 0,
    duration: 0.3,
    ease: "power3.out",
  ...
  // 2. Paragraph
  eventsTimeline.from("#events-header p", {
    y: 50,
    opacity: 0,
    duration: 0.3,
    ease: "power3.out",
  ...
  // 3. event-form-container
  eventsTimeline.from(".event-form-container", {
    y: 50,
    opacity: 0,
    duration: 0.75,
    ease: "power3.out",
