document.addEventListener("DOMContentLoaded", (event) => {
  ...
  const singleEventsTimeline = gsap.timeline();

  // Nav-bar
  singleEventsTimeline.from("#nav-bar-b", {
    y: -100,
    opacity: 0,
    duration: 1,
    ease: "power3.out",
  ...
  singleEventsTimeline.call(() => {
    navAnimationComplete = true;
  });

  // 1. single-event container
  singleEventsTimeline.from("#single-event", {
    y: 50,
    opacity: 0,
    duration: 0.75,
    ease: "power3.out",
